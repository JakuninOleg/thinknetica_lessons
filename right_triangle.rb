...
if a == b && b == c
  p 'Ваш треугольник равносторонний, да ещё и равнобедренный! Но не прямоугольный, увы!'
elsif  right_triangle && $array.first == $array.last
  p 'Ваш треугольник прямоугольный и равнобедренный! Бинго!'
elsif right_triangle
  p 'Ваш треугольник прямоугольный! Ура!'
else
  p 'К сожалению, Ваш треугольник не прямоугольный'
end
